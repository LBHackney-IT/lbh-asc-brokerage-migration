...
ActiveRecord::Schema[7.0].define(version: 2022_04_20_161434) do
  ...
  create_enum "element_status", ["in_progress", "awaiting_approval", "approved", "inactive", "active", "ended", "suspended"]
  create_enum "provider_type", ["framework", "spot"]
  create_enum "referral_status", ["unassigned", "in_review", "assigned", "on_hold", "archived", "in_progress", "awaiting_approval", "approved"]
  ...
  create_table "elements", id: :integer, default: nil, force: :cascade do |t|
    ...
    t.index ["related_element_id"], name: "ix_elements_related_element_id"
  end

  create_table "provider_services", primary_key: ["provider_id", "service_id"], force: :cascade do |t|
    t.integer "provider_id", null: false
    t.integer "service_id", null: false
    t.text "subjective_code", null: false
  ...
  add_foreign_key "elements", "elements", column: "related_element_id", name: "fk_elements_elements_related_element_id", on_delete: :restrict
